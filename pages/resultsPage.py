...
class results():
    def __init__(self, page: Page):
        ...
        self.page=page
        self.clickOnAddToCart = lambda product: page.locator(f'(//*[contains(@aria-label,"{product}")])[1]/ancestor::div[@class="a-section a-spacing-small a-spacing-top-small"]//button[@aria-label="Add to cart"]')
        #self.product = "iphone 17 pro"
        #elf.addToCart1Tb = page.locator('(//*[contains(@aria-label,"iPhone Air 1 TB")])[1]/ancestor::div[@class="a-section a-spacing-small a-spacing-top-small"]//button[@aria-label="Add to cart"]')
